...
public interface OrderRepository extends JpaRepository<Order, Long> {
  ...
  @Query(
      value =
          "SELECT DISTINCT o FROM Order o JOIN o.orderItems oi WHERE oi.product.user.id = :sellerId",
      countQuery =
          "SELECT COUNT(DISTINCT o.id) FROM Order o JOIN o.orderItems oi WHERE oi.product.user.id = :sellerId")
